...
/**
 * This is the item provider adapter for a {@link laBouR.Route} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RouteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGridbasepointerPropertyDescriptor(object);
	...
	protected void addIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Route_ID_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Route_ID_feature", "_UI_Route_type"),
						LaBouRPackage.Literals.ROUTE__ID, true, false, false,
	...
	/**
	 * This adds a property descriptor for the Gridbasepointer feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGridbasepointerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Route_gridbasepointer_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Route_gridbasepointer_feature",
								"_UI_Route_type"),
						LaBouRPackage.Literals.ROUTE__GRIDBASEPOINTER, true, false, true, null, null, null));
	}
	...
	protected void addStepsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Route_steps_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Route_steps_feature", "_UI_Route_type"),
						LaBouRPackage.Literals.ROUTE__STEPS, true, false, true, null, null, null));
	}
